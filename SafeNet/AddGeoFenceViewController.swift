...
protocol AddGeoFenceViewControllerDelegate {
    func addGeoFenceViewController(controller: AddGeoFenceViewController, didAddCoordinate coordinate: CLLocationCoordinate2D,
...
class AddGeoFenceViewController: UITableViewController {
    ...
    @IBAction private func onAdd(sender: AnyObject) {
        ...
        delegate?.addGeoFenceViewController(controller: self, didAddCoordinate: coordinate, radius: radius, identifier: identifier, note: note!, eventType: eventType)
    }
