...
SWIFT_CLASS("_TtC7SafeNet11AppDelegate")
...
SWIFT_CLASS("_TtC7SafeNet24CheckLoginViewController")
@interface CheckLoginViewController : UIViewController
@property (nonatomic, copy) NSString * _Nonnull previousVC;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC7SafeNet30CreateNewTeacherViewController")
@interface CreateNewTeacherViewController : UIViewController
...
SWIFT_CLASS("_TtC7SafeNet19FirstViewController")
...
SWIFT_CLASS("_TtC7SafeNet20SecondViewController")
...
SWIFT_CLASS("_TtC7SafeNet26StudentLoginViewController")
...
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified teacherCodeTextField;
- (void)viewDidLoad;
- (IBAction)login:(id _Nonnull)sender;
- (void)prepareForSegue:(UIStoryboardSegue * _Nonnull)segue sender:(id _Nullable)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC7SafeNet25StudentMainViewController")
...
@interface StudentMainViewController (SWIFT_EXTENSION(SafeNet)) <CLLocationManagerDelegate>
- (void)locationManager:(CLLocationManager * _Nonnull)manager didUpdateLocations:(NSArray<CLLocation *> * _Nonnull)locations;
@end


SWIFT_CLASS("_TtC7SafeNet26TeacherLoginViewController")
...
@interface UINavigationController (SWIFT_EXTENSION(SafeNet))
- (void)presentTransparentNavigationBar;
- (void)hideTransparentNavigationBar;
@end


SWIFT_CLASS("_TtC7SafeNet27WelcomeScreenViewController")
